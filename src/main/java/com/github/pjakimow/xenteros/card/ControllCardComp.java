...
public class ControllCardComp implements Comparator<Card> {
	...
	public int compare(Card o1, Card o2) {
		if ( o1 instanceof Monster){
			if (o2 instanceof Monster){
				...
				if ( ((Monster)o1).getMonsterAbility() == MonsterAbility.TAUNT ){
					if ( ((Monster)o2).getMonsterAbility() != MonsterAbility.TAUNT){
						return -1;
					} else {
				...
				} else if ( ((Monster)o2).getMonsterAbility() == MonsterAbility.TAUNT ){
					return 1;
				} else {
					return ((Monster) o1).getAttack() == ((Monster) o2).getAttack() ? (((Monster) o1).getCost() < ((Monster) o2).getCost() ? -1 : 1) :
							((Monster) o1).getAttack() > ((Monster) o2).getAttack() ? -1 : 1;
				...
				return ((Monster)o1).getMonsterAbility() != MonsterAbility.TAUNT ? (
		...
		return ((Monster)o2).getMonsterAbility() == MonsterAbility.TAUNT ? (
